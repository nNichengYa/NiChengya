...
export const siteConfig: SiteConfig = {
  ...
  siteURL: "https://nichengya.pages.dev/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2026-07-27", // 站点开始运行日期，用于站点统计组件计算运行天数
  ...
  navbarTitle: {
    ...
    icon: "assets/home/home-img.webp",
    // 网站Logo图片路径
    logo: "assets/home/my-logo.webp",
  },
  ...
  banner: {
    ...
    src: {
      ...
      mobile: [
        "/assets/mobile-banner/img-1.webp",
        "/assets/mobile-banner/22.webp",
        "/assets/mobile-banner/img-3.webp",
        "/assets/mobile-banner/img-4.webp",
        "/assets/mobile-banner/img-5.webp",
        "/assets/mobile-banner/img-6.webp",
      ], // 移动横幅图片
    }, // 使用本地横幅图片
    ...
    homeText: {
      ...
      subtitle: [
        "一个不起眼的小站，记录生活点滴，分享有趣的事物",
        "欢迎来到我的小站，愿你在这里找到属于自己的快乐",
        "愿世间所有美好都能如期而至，愿你我都能不负韶华",
        "来看看我的小站吧，这里有我喜欢的东西，也许你也会喜欢",
        "今天的你，是否也在追逐梦想的路上呢？",
      ],
      typewriter: {
